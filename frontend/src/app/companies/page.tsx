    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="relative flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <h1 className="text-2xl font-bold text-[#000000]">Vendors</h1>
              </div>
              <p className="text-sm text-[#333333]">
                Discover and connect with {companies.length} {companies.length === 1 ? "vendor" : "vendors"} in the network
              </p>
            </div>
      ...
      {filtered.length === 0 && (
        <div className="card text-center py-16">
          ...
          <p className="font-semibold text-[var(--foreground)]">No vendors found</p>
