...
export default function ProfilePage() {
  ...
  const deriveUsernameFromCompanyName = (companyName: string) =>
    companyName
      .trim()
      .toLowerCase()
      .replace(/\s+/g, "-")
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      setUsername((profileUser as { username?: string } | null)?.username || "");
  ...
  const displayUsername = username || (profile?.company_name ? deriveUsernameFromCompanyName(profile.company_name) : "");
                ...
                <>
                  ...
                  <div className="rounded-xl p-6" style={{ background: "#E5E2D8", border: "1px solid #D4D1C8" }}>
                    ...
                    <div className="space-y-0 divide-y" style={{ borderColor: "#D4D1C8" }}>
                      {[
                        { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5h7.5m-7.5 0A2.25 2.25 0 0 0 6 6.75v10.5A2.25 2.25 0 0 0 8.25 19.5h7.5A2.25 2.25 0 0 0 18 17.25V6.75A2.25 2.25 0 0 0 15.75 4.5m-7.5 0V3h7.5v1.5" /></svg>, label: "Username", value: displayUsername || "Not set yet" },
